  ...
  __in HANDLE template_file)
{
  ...
  temp_CreateFile = static_cast<HANDLE(WINAPI *)(LPCSTR,
                    ...
                    DWORD,
                    DWORD,
                    HANDLE)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("CreateFileA"),
                                     STRONG_SEED));
                         ...
                         PDWORD lpflOldProtect)
{
  ...
  temp_VirtualProtect = static_cast<BOOL(WINAPI *)(LPVOID,
                        SIZE_T,
                        DWORD,
                        PDWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen(func),
                                         STRONG_SEED));
                         ...
                         DWORD flProtect)
{
  ...
  temp_VirtualAlloc = static_cast<LPVOID(WINAPI *)(LPVOID,
                      SIZE_T,
                      DWORD,
                      DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("VirtualAlloc"),
                                      STRONG_SEED));
                      ...
                      DWORD dwFreeType)
{
  ...
  temp_VirtualFree = static_cast<BOOL(WINAPI *)(LPVOID,
                     SIZE_T,
                     DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("VirtualFree"),
                                     STRONG_SEED));
                        ...
                        DWORD dwFreeType)
{
  ...
  temp_VirtualFreeEx = static_cast<BOOL(WINAPI *)(HANDLE,
                       LPVOID,
                       SIZE_T,
                       DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("VirtualFreeEx"),
                                       STRONG_SEED));
                           ...
                           DWORD ucchMax)
{
  ...
  temp_QueryDosDeviceW = static_cast<DWORD(WINAPI *)(LPCWSTR,
                         LPWSTR,
                         DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("QueryDosDeviceW"),
                                         STRONG_SEED));
...
HMODULE hash_LoadLibraryW(LPCWSTR lpLibFileName)
{
  ...
  const auto _hash = t1ha0(func, strlen(func), STRONG_SEED);
  temp_LoadLibraryW = static_cast<HMODULE(WINAPI *)(LPCWSTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen(func),
                      STRONG_SEED));
                            ...
                            LPCSTR lpProcName)
{
  ...
  temp_GetProcAddress = static_cast<FARPROC(WINAPI *)(HMODULE,
                        LPCSTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("GetProcAddress"),
                                         STRONG_SEED));
...
DWORD hash_GetTickCount()
{
  ...
  temp_GetTickCount = static_cast<DWORD(WINAPI *)()>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("GetTickCount"),
                      STRONG_SEED));
...
void hash_SetLastError(DWORD dwErrCode)
{
  ...
  temp_SetLastError = static_cast<void(WINAPI *)(DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("SetLastError"),
                      STRONG_SEED));
...
_Post_equals_last_error_ DWORD hash_GetLastError()
{
  ...
  temp_GetLastError = static_cast<DWORD(WINAPI *)()>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("GetLastError"),
                      STRONG_SEED));
                          ...
                          va_list *Arguments)
{
  ...
  temp_FormatMessageW = static_cast<DWORD(WINAPI *)(DWORD,
                        ...
                        LPWSTR,
                        DWORD,
                        va_list *)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("FormatMessageW"),
                                    STRONG_SEED));
                         ...
                         LPCWSTR lpName)
{
  ...
  temp_CreateMutexW = static_cast<HANDLE(WINAPI *)(LPSECURITY_ATTRIBUTES,
                      BOOL,
                      LPCWSTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("CreateMutexW"),
                                        STRONG_SEED));
                         ...
                         LPCWSTR lpName)
{
  ...
  temp_CreateEventW = static_cast<HANDLE(WINAPI *)(LPSECURITY_ATTRIBUTES,
                      BOOL,
                      BOOL,
                      LPCWSTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("CreateEventW"),
                                        STRONG_SEED));
...
BOOL hash_SetEvent(HANDLE hEvent)
{
  ...
  temp_SetEvent = static_cast<BOOL(WINAPI *)(HANDLE)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("SetEvent"), STRONG_SEED));
                        ...
                        ULONG_PTR dwData)
{
  ...
  temp_QueueUserAPC = static_cast<DWORD(WINAPI *)(PAPCFUNC,
                      HANDLE,
                      ULONG_PTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("QueueUserAPC"),
                                          STRONG_SEED));
                         ...
                         LPDWORD lpThreadId)
{
  ...
  temp_CreateThread = static_cast<HANDLE(WINAPI *)(LPSECURITY_ATTRIBUTES,
                      ...
                      DWORD,
                      LPDWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("CreateEventW"),
                                        STRONG_SEED));
                           ...
                           BOOL fResume)
{
  ...
  temp_SetWaitableTimer = static_cast<BOOL(WINAPI *)(HANDLE,
                          ...
                          PTIMERAPCROUTINE,
                          LPVOID,
                          BOOL)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("SetWaitableTimer"),
                                         STRONG_SEED));
                          ...
                          DWORD dwMoveMethod)
{
  ...
  temp_SetFilePointer = static_cast<DWORD(WINAPI *)(HANDLE,
                        LONG,
                        PLONG,
                        DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("SetFilePointer"),
                                        STRONG_SEED));
                   ...
                   LPOVERLAPPED lpOverlapped)
{
  ...
  temp_ReadFile = static_cast<BOOL(WINAPI *)(HANDLE,
                  ...
                  DWORD,
                  LPDWORD,
                  LPOVERLAPPED)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("ReadFile"),
                                         STRONG_SEED));
                        ...
                        HANDLE hTemplateFile)
{
  ...
  temp_CreateFileW = static_cast<HANDLE(WINAPI *)(LPCWSTR,
                     ...
                     DWORD,
                     DWORD,
                     HANDLE)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("CreateFileW"),
                                      STRONG_SEED));
                       ...
                       SIZE_T uBytes)
{
  ...
  temp_LocalAlloc = static_cast<HLOCAL(WINAPI *)(UINT,
                    SIZE_T)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("LocalAlloc"),
                                     STRONG_SEED));
...
SIZE_T hash_LocalSize(HLOCAL hMem)
{
  ...
  temp_LocalSize = static_cast<SIZE_T(WINAPI *)(HLOCAL)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("LocalSize"),
                   STRONG_SEED));
                      ...
                      SIZE_T dwBytes)
{
  ...
  temp_HeapAlloc = static_cast<LPVOID(WINAPI *)(HANDLE,
                   DWORD,
                   SIZE_T)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("HeapAlloc"),
                                    STRONG_SEED));
...
HANDLE hash_GetProcessHeap()
{
  ...
  temp_GetProcessHeap = static_cast<HANDLE(WINAPI *)()>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("GetProcessHeap"),
                        STRONG_SEED));
                       ...
                       UINT_PTR ucb)
{
  ...
  temp_IsBadReadPtr = static_cast<BOOL(WINAPI *)(const VOID *,
                      UINT_PTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("IsBadReadPtr"),
                                         STRONG_SEED));
...
HANDLE hash_GetCurrentProcess()
{
  ...
  temp_GetCurrentProcess = static_cast<HANDLE(WINAPI *)()>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("GetCurrentProcess"),
                           STRONG_SEED));
...
void hash_Sleep(DWORD dwMilliseconds)
{
  ...
  temp_Sleep = static_cast<void(WINAPI *)(DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("Sleep"), STRONG_SEED));
                        ...
                        DWORD dwProcessId)
{
  ...
  temp_OpenProcess = static_cast<HANDLE(WINAPI *)(DWORD,
                     BOOL,
                     DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("OpenProcess"),
                                     STRONG_SEED));
...
BOOL hash_SwitchToThread()
{
  ...
  temp_SwitchToThread = static_cast<BOOL(WINAPI *)()>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("SwitchToThread"),
                        STRONG_SEED));
                         ...
                         PBOOL Wow64Process)
{
  ...
  temp_IsWow64Process = static_cast<BOOL(WINAPI *)(HANDLE,
                        PBOOL)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("IsWow64Process"),
                                        STRONG_SEED));
                       ...
                       DWORD dwThreadId)
{
  ...
  temp_OpenThread = static_cast<HANDLE(WINAPI *)(DWORD,
                    BOOL,
                    DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("OpenThread"),
                                    STRONG_SEED));
...
DWORD hash_GetCurrentThreadId()
{
  ...
  temp_GetCurrentThreadId = static_cast<DWORD(WINAPI *)()>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("GetCurrentThreadId"),
                            STRONG_SEED));
                           ...
                           UINT uExitCode)
{
  ...
  temp_TerminateProcess = static_cast<BOOL(WINAPI *)(HANDLE,
                          UINT)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("TerminateProcess"),
                                         STRONG_SEED));
...
BOOL hash_CloseHandle(HANDLE hObject)
{
  ...
  temp_CloseHandle = static_cast<BOOL(WINAPI *)(HANDLE)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("CloseHandle"),
                     STRONG_SEED));
                          ...
                          DWORD dwOptions)
{
  ...
  temp_DuplicateHandle = static_cast<BOOL(WINAPI *)(HANDLE,
                         ...
                         DWORD,
                         BOOL,
                         DWORD)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("DuplicateHandle"),
                                         STRONG_SEED));
...
int hash_lstrlenW(LPCWSTR lpString)
{
  ...
  temp_lstrlenW = static_cast<int(WINAPI *)(LPCWSTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("lstrlenW"), STRONG_SEED));
...
HANDLE hash_CreateTimerQueue()
{
  ...
  temp_CreateTimerQueue = static_cast<HANDLE(WINAPI *)()>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen("CreateTimerQueue"),
                          STRONG_SEED));
                               ...
                               PCWSTR          SourceString)
{
  ...
  const auto _hash = t1ha0(func, strlen(func), STRONG_SEED);
  temp_RtlInitUnicodeString = static_cast<void(*)(PUNICODE_STRING, PCWSTR)>(get_api( _hash, (LPCSTR)PRINT_HIDE_STR("ntdll.dll"), strlen(func), STRONG_SEED));
...
NTSTATUS hash_NtClose(IN HANDLE Handle)
{
  ...
  const auto _hash = t1ha0(func, strlen(func), STRONG_SEED);
  temp_NtClose = static_cast<NTSTATUS(*)(IN HANDLE)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("ntdll.dll"), strlen(func), STRONG_SEED));
...
BOOL hash_FreeLibrary(HMODULE hLibModule)
{
  ...
  const auto _hash = t1ha0(func, strlen(func), STRONG_SEED);
  temp_FreeLibrary = static_cast<BOOL(*)(HMODULE)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen(func), STRONG_SEED));
...
HMODULE hash_LoadLibraryAA(LPCSTR lpLibFileName)
{
  ...
  const auto _hash = t1ha0(func, strlen(func), STRONG_SEED);
  temp_LoadLibraryAA = static_cast<HMODULE(*)(LPCSTR)>(get_api(_hash, (LPCSTR)PRINT_HIDE_STR("kernel32.dll"), strlen(func), STRONG_SEED));
