...
#define FIXED_KEY \
	...
	inline static uint32_t * xxtea_to_uint_array(const uint8_t * data, size_t len, int inc_len, size_t * out_len)
	{
		uint32_t *out;
	...
	inline static uint8_t * xxtea_to_ubyte_array(const uint32_t * data, size_t len, int inc_len, size_t * out_len)
	{
		uint8_t *out;
#if !(defined(BYTE_ORDER) && (BYTE_ORDER == LITTLE_ENDIAN))
		size_t i;
	...
	inline static uint32_t * xxtea_uint_encrypt(uint32_t * data, size_t len, uint32_t * key)
	{
	...
	inline static uint32_t * xxtea_uint_decrypt(uint32_t * data, size_t len, uint32_t * key)
	{
		uint32_t n = (uint32_t)len - 1;
	...
	inline static uint8_t * xxtea_ubyte_encrypt(const uint8_t * data, size_t len, const uint8_t * key, size_t * out_len)
	{
		uint8_t *out;
	...
	inline static uint8_t * xxtea_ubyte_decrypt(const uint8_t * data, size_t len, const uint8_t * key, size_t * out_len)
	{
		uint8_t *out;
		uint32_t *data_array, *key_array;
		size_t data_len, key_len;
 ...
 */
 ...
 // public functions
	inline void * xxtea_encrypt(const void * data, size_t len, const void * key, size_t * out_len)
	{
		FIXED_KEY
...
inline void * xxtea_decrypt(const void * data, size_t len, const void * key, size_t * out_len)
{
	FIXED_KEY
